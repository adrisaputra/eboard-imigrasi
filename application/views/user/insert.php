 						...
 						<table class="table table-bordered table-striped">
 							<tr>
								...
								<span class="required">*</span></th>
 								<td><input type="text" class="form-control" name="first_name" value="<?php echo set_value('first_name'); ?>"></td>
 							</tr>
 							<tr>
 								<th class="col-md-3">Nama Belakang</th>
 								<td><input type="text" class="form-control" name="last_name" value="<?php echo set_value('last_name'); ?>"></td>
 							</tr>
 							<tr>
 								<th class="col-md-3">Telepon</th>
 								<td><input type="text" class="form-control" name="phone" value="<?php echo set_value('phone'); ?>"></td>
 							</tr>
 							<tr>
 								<th class="col-md-3">
								<?php 
								...
								?>
								<span class="required">*</span></th>
 								<td><input type="text" class="form-control" name="username" value="<?php echo set_value('username'); ?>"></td>
 							</tr>
 							<tr>
 								<th class="col-md-3">
								<?php 
								...
								?>
								<span class="required">*</span></th>
 								<td><input type="email" class="form-control" name="email" value="<?php echo set_value('email'); ?>"></td>
 							</tr>
 							<tr>
 								<th class="col-md-3">
								<?php 
 							...
 							<tr>
								...
								<span class="required">*</span>
 								...
 								<td><select class="form-control" name="groups[]">
										...
										<?php
										foreach ($groups as $v) {?>
											<option value="<?php echo $v->id ?>" <?php if (set_value('groups[]')==$v->id){ echo "selected";}?>><?php echo $v->name ?></option>
										<?php }
										?>
									</select>
								</td>
