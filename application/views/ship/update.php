  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ubah Jadwal Kapal</li>
      </ol>
    </section>
 			...
 			<div class="col-md-12">
 				...
 				<div class="box">
 					<div class="box-header with-border">
 						<h3 class="box-title">UBAH JADWAL KAPAL</h3>
 					</div>
 					<!-- /.box-header -->
 					<!-- form start -->

 					<?php echo form_open_multipart('ship/update'); ?>
 					<div class="table-responsive box-body">
 						<table class="table table-bordered table-striped">
							<input type="hidden" class="form-control" name="ship_id" value="<?php echo $entry['ship_id']?>">
							<tr>
 								<th class="col-md-3">
								<?php 
								...
								<span class="required">*</span></th>
 								<td><input type="text" class="form-control" name="ship_name" value="<?php if(set_value('ship_name')){
										echo set_value('ship_name');
									}else {
										echo $entry['ship_name'];
									} ; ?>"></td>
 							</tr>
 							<tr>
 								<th class="col-md-3">
								...
								?>
								<span class="required">*</span></th>
 								<td><input type="text" class="form-control" name="destination" value="<?php if(set_value('destination')){
										echo set_value('destination');
									}else {
							...
							<!-- Tanggal Tiba -->
 							<tr>
								...
								<span class="required">*</span></th>
 								<td><div class="input-group col-md-12">
										<input id="datepicker3" type="text" class="form-control" name="arrived_date" value="<?php if(set_value('arrived_date')){
											...
											echo date("d-m-Y", strtotime($entry['arrived_date']));
										} ; ?>">
								...
								<span class="required">*</span></th>
 								<td><div class="input-group col-md-12">
										<input  type="text" class="form-control clockpicker3" name="arrived_time" value="<?php if(set_value('arrived_time')){
											echo set_value('arrived_time');
										}else {
											echo $entry['arrived_time'];
										} ; ?>">
							...
							<!-- Tanggal Sandar -->
 							<tr>
								...
								<span class="required">*</span></th>
 								<td><div class="input-group col-md-12">
										<input id="datepicker2" type="text" class="form-control" name="leaning_date" value="<?php if(set_value('leaning_date')){
											...
											echo date("d-m-Y", strtotime($entry['leaning_date']));
										} ; ?>">
										<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
									</div>
								</td>
								...
								<span class="required">*</span></th>
 								<td><div class="input-group col-md-12">
										<input  type="text" class="form-control clockpicker2" name="leaning_time" value="<?php if(set_value('leaning_time')){
											echo set_value('leaning_time');
										}else {
											echo $entry['leaning_time'];
										} ; ?>">
										<span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
									</div>
								</td>
							...
							<!-- Tanggal Berangkat -->
 							<tr>
								...
								<span class="required">*</span></th>
 								<td><div class="input-group col-md-12">
										<input  type="text" class="form-control clockpicker" name="start_time" value="<?php if(set_value('start_time')){
