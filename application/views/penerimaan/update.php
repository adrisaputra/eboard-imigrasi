      ...
      <div class="row">
 			...
 			<div class="col-md-12">
 				...
 				<div class="box">
 					...
 					<?php echo form_open_multipart('penerimaan/update/'); ?>
 					<div class="table-responsive box-body">
 						<table class="table table-bordered table-striped">
							<input type="hidden" class="form-control" name="penerimaan_id" value="<?php echo $entry['penerimaan_id']?>">
							<tr>
 								<th class="col-md-3">
								<?php 
								...
								<span class="required">*</span></th>
 								<td><input type="text" class="form-control" name="jenis_penerimaan" value="<?php if(set_value('jenis_penerimaan')){
										echo set_value('jenis_penerimaan');
									}else {
										echo $entry['jenis_penerimaan'];
									} ; ?>"></td>
							...
							<tr>
								...
								?>
								<span class="required">*</span></th>
 								<td><input type="text" class="form-control" name="jumlah" onkeyup="formatRupiah(this, '.')" value="<?php if(set_value('jumlah')){
										echo set_value('jumlah');
									}else {
										echo number_format($entry['jumlah'], 0, ',', '.');
									} ; ?>"></td>
