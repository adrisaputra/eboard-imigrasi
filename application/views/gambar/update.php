      ...
      <div class="row">
 			...
 			<div class="col-md-12">
 				...
 				<div class="box">
 					...
 					<?php echo form_open_multipart('gambar/update/'); ?>
 					<div class="table-responsive box-body">
 						<table class="table table-bordered table-striped">
							<input type="hidden" class="form-control" name="gambar_id" value="<?php echo $entry['gambar_id']?>">
							<tr>
 								<th class="col-md-3">
								<?php 
								...
								<span class="required">*</span></th>
 								<td><input type="text" class="form-control" name="nama_gambar" value="<?php if(set_value('nama_gambar')){
										echo set_value('nama_gambar');
									}else {
										echo $entry['nama_gambar'];
									} ; ?>"></td>
 							...
 							<tr>
								...
								?>
								<span class="required">*</span></th>
 								<td><input type="file" name="userfile" size="20" /><br>
								 <img src="<?php echo base_url();?>upload/gambar/<?php echo $entry['gambar']; ?>" width="290px" height="520px"></td>
 							</tr>
 						</table>
 					</div>
 					<!-- /.box-body -->
