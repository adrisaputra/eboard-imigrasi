 						...
 						<table class="table table-bordered table-striped">
 							<tr>
								...
								<span class="required">*</span></th>
 								<td><input type="text" class="form-control" name="video_name" value="<?php echo set_value('video_name'); ?>"></td>
 							</tr>
 							<tr>
 								<th class="col-md-3">
								<?php 
								...
								?>
								<span class="required">*</span></th>
 								<td><input type="text" class="form-control" name="link" value="<?php echo set_value('link'); ?>"></td>
 							</tr>
 						</table>
 					</div>
 					<!-- /.box-body -->
