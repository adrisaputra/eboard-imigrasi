...
">
	 <br>
      ...
      <div class="row">
        ...
        <div class="col-lg-1 col-xs-12" style="flex: 0 0 19.444444%;max-width: 19.444444%;padding-right: 0px;">
        <img src="<?php echo base_url();?>upload/red.jpg" width="100%" height="520">
        </div>
        ...
        <div class="col-lg-1 col-xs-12" style="flex: 0 0 19.444444%;max-width: 19.444444%;padding-left: 0px;">
        <img src="<?php echo base_url();?>upload/red.jpg" width="100%" height="520">
        </div>
        <div class="col-lg-1 col-xs-12"></div>
      </div>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          ...
                          foreach($realisasi as $v) { 
						                ...
						                $belanja_modal = $belanja_modal+$v->belanja_modal;
                            ?>
